...
const vec4 TRAIL_COLOR = vec4(0.64, 1.00, 0.65, 1.0); //vec4(0.00, 0.11, 0.92, 1.0); //vec4(1.0, 0.25, 0.161, 1.0); // yellow
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.44, 0.94, 0.45, 1.0); //vec4(1.0, 0., 0., 1.0); // red-orange
const float DURATION = .35;
const float OPACITY = .25;
